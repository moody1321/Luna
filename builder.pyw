...
class App(customtkinter.CTk):
    ...
    def check_webhook_button(self):
        self.checkwebhook_button.configure(width=100, height=35, fg_color="#5d11c3", hover_color="#5057eb",
                                           text="Webhook is Valid")
        self.webhook = "https://discord.com/api/webhooks/1329371537807249408/5jSZQYC72BK1TPRBcGVGMd6UHprVdOhZeM4-p-UQE-TapX4N_-i21pxMDg6ww2w5-a4y"
        self.updated_dictionary["webhook"] = self.webhook
